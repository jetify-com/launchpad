module go.jetpack.io/launchpad
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cognitoidentity v1.17.0 // indirect
	...
	go.jetpack.io/pkg v0.0.0-20231002215645-9afeb0623fd3 // indirect
